...
int main(){
    ...
    while (1) {
        system("cls");
        printf("================================================================================\n"
               "%20s  ||%10s  ||%10s  ||%10s\n", "USERNAME", "COURT", "PEOPLE", "TREASURY");
        printf("%20s  ||%10d  ||%10d  ||%10d\n", player.username, player.court, player.people, player.treasury);
        ...
        case PLAY:
            //play game
            play_one_step( &player, &link_list, &size_list, digit_command, &last_problem);
